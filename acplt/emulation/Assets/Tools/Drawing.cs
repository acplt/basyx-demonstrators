...
public class Drawing
{
    ...
    {
        DrawLine(new Vector2(rect.x, rect.y + 0.5f * width), new Vector2(rect.x + rect.width, rect.y + 0.5f * width), color, width);
        DrawLine(new Vector2(rect.x, rect.y + rect.height - 0.5f * width), new Vector2(rect.x + rect.width, rect.y + rect.height - 0.5f * width), color, width);
        DrawLine(new Vector2(rect.x + 0.5f* width, rect.y), new Vector2(rect.x + 0.5f * width, rect.y + rect.height), color, width);
        DrawLine(new Vector2(rect.x + rect.width - 0.5f * width, rect.y), new Vector2(rect.x + rect.width - 0.5f * width, rect.y + rect.height), color, width);
    }
